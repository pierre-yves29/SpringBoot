...
public class ReviewDAOImpl implements ReviewDAO {
    ...
    private static final String SELECT_BY_MOVIE  = "SELECT a.id, a.note, a.commentaire, m.nom, m.prenom FROM avis AS a INNER JOIN membre AS m  ON m.id = a.id_membre WHERE id_film = :id_film";
